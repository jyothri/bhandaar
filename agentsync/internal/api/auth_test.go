...
func TestVersionAndProtocolChecks(t *testing.T) {
	srv := New(testConfig(t, map[string]string{"AGENTSYNC_MIN_AGENT_VERSION": "0.2.0", "AGENTSYNC_LATEST_AGENT_VERSION": "0.2.0"}), nil, nil, fakeDB{})
...
func TestLoginLockoutPerUsernameAndIP(t *testing.T) {
	srv, _ := dbServer(t)
	srv.cfg.TrustedProxies = testConfig(t, map[string]string{"AGENTSYNC_TRUSTED_PROXIES": "127.0.0.1"}).TrustedProxies
